    ...
    <el-table
      ...
      <el-table-column prop="orderStatus" header-align="center" align="center" label="状态">
        <template slot-scope="scope">
          ...
          <el-tag v-if="scope.row.orderStatus === '101'" size="small" type="warning">待收币</el-tag>
    ...
    <div class="phone-table">
      <div class="tr" v-for="item,i in dataList">
        ...
        <phone-column :data="dataList" :index="i" label="操作">
          <template slot-scope="scope">
            <el-button v-if="scope.row.isNotifySuccess != 1 && scope.row.orderStatus === '102' && isAuth('app:payorder:notice')" type="primary" size="small" @click="notice(scope.row.orderId)">通知第三方充币</el-button>
          </template>
        </phone-column>
      </div>
    </div>
