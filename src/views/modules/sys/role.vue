<template>
  <div class="mod-role">
    ...
    <el-table
      ...
      <el-table-column prop="roleName" header-align="center" align="center" width="300" label="角色名称">
      </el-table-column>
    ...
    <div class="phone-table">
      <div class="tr" v-for="item,i in dataList">
        ...
        <phone-column :prop="item.roleName" label="角色名称"></phone-column>
        <phone-column :prop="item.remark" label="备注"></phone-column>
  ...
  export default {
    ...
    methods: {
      ...
      deleteHandle (id, roleName) {
        ...
        this.$confirm(`确定对[${roleNames.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
